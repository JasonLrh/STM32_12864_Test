##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.3.0] date: [Tue Jun 11 17:53:55 CST 2019] 
##########################################################################################################################
...
CFLAGS += -MMD -MP -MF"$(@:%.o=%.d)" --specs=nano.specs -u _printf_float
...
# libraries
LIBS = -lc -lm -lnosys -lgcc -lrdimon
LIBDIR = 
